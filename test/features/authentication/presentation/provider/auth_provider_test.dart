...
void main() {
  group('AuthProvider', () {
    ...
    test('login successful should update state and currentUser', () async {
      // Arrange
      when(mockLoginUseCase.execute(any<String>(), any<String>())).thenAnswer((_) async => tUser);
    ...
    test('login throws exception should update state and errorMessage', () async {
      // Arrange
      when(mockLoginUseCase.execute(any<String>(), any<String>())).thenThrow(Exception('Network error'));
