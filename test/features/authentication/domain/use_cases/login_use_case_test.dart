...
void main() {
  group('LoginUseCase', () {
    ...
    test('should return User when login is successful', () async {
      ...
      when(mockAuthRepository.login(any<String>(), any<String>())).thenAnswer((_) async => tUser);
    ...
    test('should return null when login fails (repository returns null)', () async {
      ...
      when(mockAuthRepository.login(any<String>(), any<String>())).thenAnswer((_) async => null);
